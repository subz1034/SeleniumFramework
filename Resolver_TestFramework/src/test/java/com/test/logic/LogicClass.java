...
public class LogicClass {
	...
	void setupTest() {
		...
		driver.get("file:///" + System.getProperty("user.dir") + "/src/test/resources/QE-index.html");
	...
	/*
	 * Exercise 1 Assert that both the email address and password inputs are present
	 * as well as the login button Enter in an email address and password
	 * combination into the respective fields
	 */
	@Test
	void test1() {
		try {
	...
	/*
	 * In the test 2 div, assert that there are three values in the listgroup Assert
	 * that the second list item's value is set to "List Item 2" Assert that the
	 * second list item's badge value is 6
	 */
	@Test
	void test2() {
		try {
